    ...
    <div class="card-body">
        <div class="row">
            <div class="col mb-3">
                ...
                <input
                    ...
                    required
                    minlength="2"
                    value="<?php echo $director?->getName() ?? '' ?>" />
            </div>
        </div>
        <div class="row">
            <div class="col mb-3">
                ...
                <input
                    ...
                    required
                    minlength="2"
                    value="<?php echo $director?->getSurname() ?? '' ?>" />
            </div>
        </div>
        <div class="row">
            <div class="col mb-3">
                ...
                <input
                    ...
                    required
                    minlength="2"
                    value="<?php echo $director?->getBirthday() ?? '' ?>" />
            </div>
        </div>
        <div class="row">
            <div class="col mb-3">
                ...
                <input
                    ...
                    required
                    minlength="2"
                    value="<?php echo $director?->getNationality() ?? '' ?>" />
            </div>
        </div>
        <div class="row">
            <div class="col mb-3">
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="isDirector" value="1" <?php if (isset($director) && $director->isDirector()) echo 'checked' ?>>
                    <label class="form-check-label" for="isDirector">Director</label>
                </div>
            </div>
            <div class="col mb-3">
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="isActor" value="1" <?php if (isset($director) && $director->isActor()) echo 'checked' ?>>
        ...
        <div class="row ">
            <div class="col mb-3 btn-group" role="group">
                ...
                <a href="/directors/list" class="btn btn-warning">Cancelar</a>
            </div>
        </div>
    </div>
</form>