  ...
  <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 col-xl-2 mb-2">
    <div class="card border-primary border-3 shadow">
      <div class="card-body">
        ...
        <a href="/platforms/" class="btn btn-primary">Ir al listado</a>
      </div>
    </div>
  </div>
  <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 col-xl-2 mb-2">
    <div class="card border-primary border-3 shadow">
      <div class="card-body">
        ...
        <a href="/languages/" class="btn btn-primary">Ir al listado</a>
      </div>
    </div>
  </div>
  <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 col-xl-2 mb-2">
    <div class="card border-primary border-3 shadow">
      <div class="card-body">
        ...
        <a href="/directors/" class="btn btn-primary">Ir al listado</a>
      </div>
    </div>
  </div>
  <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 col-xl-2 mb-2">
    <div class="card border-primary border-3 shadow">
      <div class="card-body">
        ...
        <a href="/actors/" class="btn btn-primary">Ir al listado</a>
      </div>
    </div>
  </div>
  <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 col-xl-2 mb-2">
    <div class="card border-primary border-3 shadow">
      <div class="card-body">
        ...
        <a href="/series/" class="btn btn-primary">Ir al listado</a>
      </div>
    </div>
  </div>
</div>
